$(document).ready(function () {
    ...
    var portuguese = {
        navbar: {
            ...
            page: "index-en.html",
            dropdowns: [
                {title: "Sobre a EBEC", menu:["EBEC Aveiro", "Edições Anteriores", "Programa", "Inscrição", "Testemunhos"]},
                {title: "Mais sobre a EBEC", menu: ["FAQ","Júri","Parceiros","Equipa","Torne-se nosso Parceiro","Contactos"]},
        ...
        ebecAveiro: {
            ...
            seccoes: {
                ...
                seccao2: {
                    title: "Modalidades",
                    modalidades: [
                        {title: "Case Study", corpo: "Os participantes terão a oportunidade de resolver dois casos de estudo fornecidos por empresas, " +
        ...
        programa: {
            ...
            schedule: [
                {diaSemana: "Quinta", diaMes: "14 março",
                    eventos: [
                        {hora: "16:00 - 17:30", nome: "Cocktail Network", local: "Complexo Pedagógico, Universidade de Aveiro"}
                    ]
                },
                {diaSemana: "Sexta", diaMes: "15 março",
                    eventos: [
                        {hora: "18:00 - 20:00", nome: "Best Training Days", local: "Complexo Pedagógico, Universidade de Aveiro"}
                    ]
                },
                {diaSemana: "Sábado", diaMes: "16 março",
                    eventos: [
                        ...
                        {hora: "11:30 - 12:30", nome: "Apresentação das empresas", local: "DAO, Universidade de Aveiro"},
        ...
        juri: {
            ...
            juri1: [
                {nome: "Vitor Bonifácio", foto: 'assets/img/juri/1.jpg', conta: "https://www.linkedin.com/in/vitor-bonif%C3%A1cio-473455127/"},
                {nome: "Ricardo Sousa", foto: "assets/img/juri/2.jpg", conta: "https://www.linkedin.com/in/ricardo-sousa-02a61317/"},
            ...
            juri2: [
                ...
                {nome: "João Labrincha", foto: "assets/img/juri/5.jpg", conta: "https://www.linkedin.com/in/jo%C3%A3o-labrincha-0b69549/"}
            ]
        },
        partners: {
        ...
        team: {
            ...
            equipa: [
                ...
                {nome: "Dalila Marques",role:"Responsável de Relações Empresariais",foto: "assets/img/team/dalila.jpg"},
                {nome: "Ana Rita Silva",role:"Responsável de Marketing",foto: "assets/img/team/anaRita.jpg"}
            ],
            equipa2: [
                {nome: "Renan Ferreira",role:"Responsável de Tecnologias de Informação",foto: "assets/img/team/renan.jpg"},
        ...
        contacts:{
            ...
            people:[
                {foto: "assets/img/team/david-2.jpg", nome: "Pedro D. Gomes", role: "Coordenador da EBEC Aveiro 2019",
                    tel: "+(351) 938 097 366", email: "mailto:pedrodavid1969@gmail.com", email2: "pedrodavid1969@gmail.com"},
                {foto: "assets/img/team/jorge.jpg", nome: "Jorge Silva", role: "Presidente do BEST Aveiro",
                    tel: "+(351) 917 077 293", email: "mailto:jorge.silva@BEST.eu.org", email2: "jorge.silva@BEST.eu.org"},
                {foto: "assets/img/team/dalila-2.jpg", nome: "Dalila Marques", role: "Responsável de Relações Empresariais",
                    tel: "+(351) 917 369 988", email: "mailto:dalilarakelam@gmail.com", email2: "dalilarakelam@gmail.com"}
            ]
        },
        bestAveiro: {
        ...
        info: {
            ...
            infos: [
                {chave: "Morada", valor: "Incubadora de Empresas da Universidade de Aveiro<br/>Campus Universitário de Santiago, Edifício 1<br/>" +
                        "3810-193 Aveiro<br/>Portugal", classe: "fa-home"},
                {chave: "Telefone", valor: "+351 917 077 329", classe: "fa-phone"},
                {chave: "Email", valor: "<a href='mailto:aveiro@BEST.eu.org'>aveiro@BEST.eu.org</a>", classe: "fa-envelope"},
            ],
