$(document).ready(function () {
    ...
    var portuguese = {
        navbar: {
            ...
            page: "index.html",
            dropdowns: [
                {title: "About EBEC", menu:["EBEC Aveiro", "Preview Editions", "Program", "Subscribing", "Testemunhos"]},
                {title: "More About the EBEC", menu: ["FAQ","Jury","Partners","The Team","Become our partner","Contacts"]},
        ...
        ebecAveiro: {
            ...
            seccoes: {
                ...
                seccao2: {
                    title: "Modalities",
                    modalidades: [
                        {title: "Case Study", corpo: "Participants will have the opportunity to resolve two case studies " +
        ...
        programa: {
            ...
            schedule: [
                {diaSemana: "Thursday", diaMes: "March 14th",
                    eventos: [
                        {hora: "16:00 - 17:30", nome: "Cocktail Network", local: "Complexo Pedagógico, University of Aveiro"}
                    ]
                },
                {diaSemana: "Friday", diaMes: "March 15th",
                    eventos: [
                        {hora: "18:00 - 20:00", nome: "Best Training Days", local: "Complexo Pedagógico, University of Aveiro"}
                    ]
                },
        ...
        contacts:{
            ...
            people:[
                {foto: "assets/img/team/david-2.jpg", nome: "Pedro D. Gomes", role: "Coordinator of EBEC Aveiro 2019",
                    tel: "+(351) 938 097 366", email: "mailto:pedrodavid1969@gmail.com", email2: "pedrodavid1969@gmail.com"},
                {foto: "assets/img/team/jorge.jpg", nome: "Jorge Silva", role: "President of BEST Aveiro",
                    tel: "+(351) 917 077 293", email: "mailto:jorge.silva@BEST.eu.org", email2: "jorge.silva@BEST.eu.org"},
                {foto: "assets/img/team/dalila-2.jpg", nome: "Dalila Marques", role: "Corporate Relations Responsible",
        ...
        info: {
            ...
            infos: [
                {chave: "Address", valor: "Incubadora de Empresas da Universidade de Aveiro<br/>Campus Universitário de Santiago, Edifício 1<br/>" +
